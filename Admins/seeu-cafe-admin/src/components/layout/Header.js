...
const Header = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Redirect will be handled by ReduxAuthProvider
    } catch (error) {
            ...
            >
              ...
              >
                <motion.button
                  ...
                  className={`absolute left-2 text-gray-400 ${isSearchExpanded ? 'pointer-events-none' : ''}`}
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                >
                  ...
                  >
                    ...
                    {isLoading ? (
                      ...
                      <div className="px-4 py-12 text-center">
                        ...
                        <p className="text-gray-500 text-sm mt-2">ไม่มีการแจ้งเตือน</p>
                      </div>
                    ) : (
                          ...
                          >
                            <div className="flex items-start">
                              ...
                              <div className="ml-3 w-0 flex-1">
                                <p className={`text-sm font-medium ${!notification.read ? 'text-amber-800' : 'text-gray-900'}`}>
                                  {notification.title}
                                </p>
                  ...
                  >
                    ...
                    <div className="py-1">
                      ...
                      >
                        ...
                        <span className="group-hover:text-red-600">ออกจากระบบ</span>
                      </motion.button>
                    </div>
                  </motion.div>
                )}
